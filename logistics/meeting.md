...
> 典型 `0..N bytes` | RLC RX 亂序暫存量 (原為 avg transmit) | 具體值
> 典型 `0..20` | RLC RX 等待重傳封包造成的堵塞時間 | 具體值

> 以上範圍為程式邏輯推估的典型值；特殊狀況下仍可能超出。
> 
> > [TIP]
> > Generate the Table of Contents automatically using Markdown All in One extension in VS Code.
